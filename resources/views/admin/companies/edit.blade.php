            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        {{ __('Edit Company') }}
                        <a class="btn btn-primary btn-sm" href="{{ route('companies.index') }}"> Back</a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('companies.update',$company->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>Logo:</strong> <a href="{{ asset('storage/'.$company->logo) }}" target="_blank">{{ asset('storage/'.$company->logo) }}</a>
